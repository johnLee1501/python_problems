...
with open("train.csv", "r") as row:
    for fare in row:
        ...
        state = columns[2]
        statecode = columns[3]
        popest2014 = columns[4]
        medprice2015 = columns[5]
        session.execute(prepared, [rank2014, city, state, statecode, fare, popest2014, medprice2015])
